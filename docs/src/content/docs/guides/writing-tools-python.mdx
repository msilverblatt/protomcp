...
Resources expose data that MCP clients can read. See the [Resources guide](/guides/resources/) for the full pattern.
...
Prompts define reusable message templates. See the [Prompts guide](/guides/prompts/) for the full pattern.
...
Provide autocomplete for prompt and resource arguments. See [Prompts guide — Completions](/guides/prompts/#completions).
...
Request LLM calls from the MCP client. See the [Sampling guide](/guides/sampling/).
