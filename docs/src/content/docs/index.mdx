...
- [Go Guide](/guides/writing-tools-go/) — `Tool()`, functional options, `ToolResult`
- [Rust Guide](/guides/writing-tools-rust/) — `tool()` builder, `ToolResult`, `ArgDef`
- [Custom Middleware](/guides/middleware/) — intercept tool calls with before/after hooks
- [Authentication](/guides/auth/) — token and API key auth for network transports
