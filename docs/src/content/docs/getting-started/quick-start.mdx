...
- [Writing Tools (Go)](/guides/writing-tools-go/) — functional options, `ToolResult`, progress
- [Writing Tools (Rust)](/guides/writing-tools-rust/) — builder pattern, `ArgDef`, progress
